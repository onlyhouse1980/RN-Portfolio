...
const STATIC_FALLBACK_PROJECTS = [
  { num: '01', title: 'BarStart DE\nRef. App', year: '2026', link: 'https://bartender-blue.vercel.app', fallbackImage: '/barstart.png', tags: ['Next.js', 'Rest API', 'Typescript'] },
...
export async function createProjectFromForm(formData) {
  ...
  if (existingProject) {
    throw Object.assign(new Error('A project with that number already exists.'), { code: 11000 });
  }
