...
It also includes an admin dashboard for viewing orders, managing fulfillment, and updating order status, plus a responsive marketing site with reviews, social proof, mobile navigation, animations, upload flows, toast notifications, and a polished Apple-inspired configuration experience.`,
        ...
        '16': {
          title: 'VPD Tracker',
          desc: 'Vapor Pressure Deficit calculator for growing cannabis indoors. Used to optimize the temperature and humidity in the grow tent.',
        },
      },
      summary: {
...
Zusätzlich enthält sie ein Admin-Dashboard zum Anzeigen von Bestellungen, Verwalten der Erfüllung und Aktualisieren des Bestellstatus sowie eine responsive Marketingseite mit Reviews, Social Proof, mobiler Navigation, Animationen, Upload-Flows, Toast-Benachrichtigungen und einer polierten Apple-inspirierten Konfigurationserfahrung.`,
        ...
        '16': {
          title: 'VPD-Tracker',
          desc: 'Dampfdruckdefizit-Rechner (VPD) für den Anbau von Cannabis in Innenräumen. Wird verwendet, um Temperatur und Luftfeuchtigkeit im Zuchtzelt zu optimieren.',
        },
      },
      summary: {
    ...
    "projects": {
      ...
      "items": {
        ...
        "16": {
          ...
          "desc": "Calculadora de déficit de presión de vapor (VPD) para el cultivo de cannabis en interiores. Se utiliza para optimizar la temperatura y la humedad en el armario de cultivo."
        }
      },
      "summary": {
        "heading": [
  ...
  fr: {
    ...
    "projects": {
      ...
      "items": {
        ...
        "16": {
          "title": "Traqueur VPD",
          "desc": "Calculateur de déficit de pression de vapeur (VPD) pour la culture de cannabis en intérieur. Utilisé pour optimiser la température et l'humidité dans la tente de culture."
        }
      },
      "summary": {
        "heading": [
  ...
  nl: {
    ...
    "projects": {
      ...
      "items": {
        ...
        "16": {
          "title": "VPD Tracker",
          "desc": "Dampdruktekort (VPD) calculator voor het binnen kweken van cannabis. Wordt gebruikt om de temperatuur en luchtvochtigheid in de kwektent te optimaliseren."
        }
      },
      "summary": {
        "heading": [
