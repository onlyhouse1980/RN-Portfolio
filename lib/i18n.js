    ...
    projects: {
      ...
      items: {
        '01': {
          title: 'BarStart DE\nRef.-App',
          desc:
            'BarStart DE ist eine mobil-optimierte digitale Trainingsplattform für angehende Bartender. Sie kombiniert eine umfangreiche, durchsuchbare Datenbank klassischer und individueller Cocktails mit Schritt-für-Schritt-Service-Tutorials und interaktiven visuellen Anleitungen. Nutzer können eigene Kreationen hinzufügen, die nahtlos in die Bibliothek integriert werden. Ein dynamisches Quiz-System prüft Wissen zu Rezepten, Techniken und Branchenkenntnissen, mit sofortigem Feedback und Fortschrittsverfolgung. Gebaut mit Next.js und einer REST-API — das essenzielle Werkzeug für aufstrebende Bartender.',
        },
        '02': {
          title: 'OBCG\nPortal',
          desc:
