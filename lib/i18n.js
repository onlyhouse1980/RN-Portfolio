...
Zusätzlich enthält sie ein Admin-Dashboard zum Anzeigen von Bestellungen, Verwalten der Erfüllung und Aktualisieren des Bestellstatus sowie eine responsive Marketingseite mit Reviews, Social Proof, mobiler Navigation, Animationen, Upload-Flows, Toast-Benachrichtigungen und einer polierten Apple-inspirierten Konfigurationserfahrung.`,
        ...
        '13': {
          title: 'Next-Practice-App',
          desc: 'Eine praktische Next.js-Lern-App.',
        },
        '14': {
          title: 'Communiversity',
  ...
  es: {
    ...
    "projects": {
      ...
      "items": {
        ...
        "11": {
          "title": "Learn Next.Js\nNext.Js",
          "desc": "Recurso de aprendizaje de Next.Js. Lcciones, ejercicios y cuestionarios. Construí una plataforma integral con desafíos interactivos de código, comentarios en tiempo real y un plan de estudios dinámico. Incluye un editor de código personalizado. Gráficos y animaciones impulsados por Three.js y Gsap."
        },
        "12": {
          "title": "PDFKit\nNext.Js",
        ...
        "13": {
          "title": "Next-Practice-App",
          "desc": "Una aplicación de aprendizaje práctico de Next.Js."
        },
        "14": {
          "title": "Communiversity",
  ...
  fr: {
    ...
    "projects": {
      ...
      "items": {
        ...
        "13": {
          "title": "Next-Practice-App",
          "desc": "Application d'apprentissage pratique de Next.js."
        },
        "14": {
          "title": "Communiversity",
