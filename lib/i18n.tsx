...
export const translations = {
  en: {
    ...
    about: {
      ...
      stats: [
        { num: '10+', target: '10', suffix: '+', label: 'years building for the web' },
        { num: 'Next.js 16 / React 19', target: '', suffix: '', label: '' },
      ],
    },
    sectionLines: {
...
It also includes an admin dashboard for viewing orders, managing fulfillment, and updating order status, plus a responsive marketing site with reviews, social proof, mobile navigation, animations, upload flows, toast notifications, and a polished Apple-inspired configuration experience.`,
        ...
        '19': {
          title: 'ERechnungFix\nE-Invoicing SaaS',
          desc: 'ERechnungFix is a privacy-first web application designed for German freelancers, small business owners, and tax professionals to validate, inspect, and generate compliant electronic invoices (XRechnung & ZUGFeRD) directly in the browser. Starting in 2025, B2B e-invoicing is mandatory in Germany, leaving many small businesses struggling with unreadable XML files and strict compliance rules.\n\nThe platform acts as an instant XML reader and validator—parsing complex electronic invoice data (UN/CEFACT, CII, UBL) into human-readable summaries, checking required structural fields, and highlighting technical errors without uploading sensitive financial data to an external server. Users can also construct standard-compliant XRechnung files through a simple form interface.\n\nStack: Next.js 16 (App Router), React 19, TypeScript, Tailwind CSS, client-side XML parser (fast-xml-parser), and ZUGFeRD/XRechnung schema validation rules.',
        },
      },
      summary: {
...
Zusätzlich enthält sie ein Admin-Dashboard zum Anzeigen von Bestellungen, Verwalten der Erfüllung und Aktualisieren des Bestellstatus sowie eine responsive Marketingseite mit Reviews, Social Proof, mobiler Navigation, Animationen, Upload-Flows, Toast-Benachrichtigungen und einer polierten Apple-inspirierten Konfigurationserfahrung.`,
        ...
        '19': {
          title: 'ERechnungFix\nE-Invoicing SaaS',
          desc: 'ERechnungFix ist eine datenschutzfreundliche Webanwendung für Freelancer, kleine Unternehmen und Steuerberater in Deutschland, um konforme elektronische Rechnungen (XRechnung & ZUGFeRD) direkt im Browser zu prüfen, zu lesen und zu erstellen. Ab 2025 ist die B2B-E-Rechnungspflicht in Deutschland Gesetz, was viele Selbstständige vor Herausforderungen mit unlesbaren XML-Dateien stellt.\n\nDie Plattform dient als sofortiger XML-Viewer und -Validator: Sie parst komplexe E-Rechnungsdaten (UN/CEFACT, CII, UBL) in verständliche Übersichten, prüft kritische Pflichtfelder und hebt technische Fehler hervor – vollständig clientseitig ohne Server-Upload vertraulicher Finanzdaten. Zudem ermöglicht ein intuitiver Editor das Erstellen konformer XRechnungen.\n\nStack: Next.js 16 (App Router), React 19, TypeScript, Tailwind CSS, clientseitiger XML-Parser (fast-xml-parser) und ZUGFeRD/XRechnung Schema-Validierungsregeln.',
        },
      },
      summary: {
...
const SUPPORTED_LANGUAGES: Language[] = ['en', 'de', 'es', 'fr', 'nl'];
